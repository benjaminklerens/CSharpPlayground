...
namespace CSharpPlayground.Controllers
{
    public class MedicinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,DateReleased,Price")] Medicine medicine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,DateReleased,Price")] Medicine medicine)
        {
            if (id != medicine.ID)
            {
                return NotFound();
